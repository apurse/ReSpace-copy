 ...
 */
export default function SmallLayout({ RoomTitle, Content }: { RoomTitle: any; Content: any; }) {
  ...
  const { roomName, jsonData, updateJsonData, setRoomName } = useRoom();
