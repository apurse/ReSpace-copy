...
export const useSocket = () => {
  const { socket, isConnected, robotData, latencyData, QRCode, roomScanFiles, scanningMap } = useContext(WebSocketContext);
  ...
  return { socket, isConnected, robotData, sendMessage, latencyData, QRCode, roomScanFiles, scanningMap };
};
