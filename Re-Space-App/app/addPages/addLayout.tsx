...
export default function DragAndDrop() {
    ...
    const saveLayout = async (oldLayoutBoxes: Box[], newLayoutBoxes: Box[]) => {
        try {
            ...
            if (loadedLayoutIndex !== -1) {
                jsonData[user.username].layouts[loadedLayoutIndex] = layout;
            } else {
                jsonData[user.username].layouts.push(layout);
            }
                ...
                <View style={defaultStyles.body}>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <ImageBackground source={{ uri: (`data:image/png;base64,${roomScan}`) }} resizeMode="cover" style={uniqueStyles.image} />
